...
wire [flit_port_width-1:0] flit_in_mapper2; // from NoC to mapper input
wire [flit_port_width-1:0] flit_out_mapper2; // from NoC to mapper input
wire en_flit_in_mapper2;
wire [flit_port_width-1:0] flit_in_mapper3; // from NoC to mapper input
wire [flit_port_width-1:0] flit_out_mapper3; // from NoC to mapper input
wire en_flit_in_mapper3;
...
wire [31:0] value_out_mapper2;
wire [5*`DATA_WIDTH-1:0] key_out_mapper2;
wire [vc_bits:0] mapper2_put_credit;
wire en_mapper2_put_credit;
wire [vc_bits:0] mapper2_get_credit;
wire mapper2_rdy_get_credit;

wire [31:0] value_out_mapper3;
wire [5*`DATA_WIDTH-1:0] key_out_mapper3;
wire [vc_bits:0] mapper3_put_credit;
wire en_mapper3_put_credit;
wire [vc_bits:0] mapper3_get_credit;
wire mapper3_rdy_get_credit;
...
mkNetwork i_mkNetwork(
    ...
    .send_ports_3_putFlit_flit_in(flit_out_mapper2), // port 3 is mapper2
    .EN_send_ports_3_putFlit(flit_out_mapper2[flit_port_width-1]),

    .EN_send_ports_3_getCredits(mapper2_rdy_get_credit),
    .send_ports_3_getCredits(mapper2_get_credit),

    .send_ports_4_putFlit_flit_in(flit_out_mapper3), // port 4 is mapper3
    .EN_send_ports_4_putFlit(flit_out_mapper3[flit_port_width-1]),

    .EN_send_ports_4_getCredits(mapper3_rdy_get_credit),
    .send_ports_4_getCredits(mapper3_get_credit),
...
//    .EN_recv_ports_1_getFlit(flit_in_mapper0[flit_port_width-1]), // mapper 0
    ...
    .EN_recv_ports_3_getFlit(1'b1), // mapper 2
    .recv_ports_3_getFlit(flit_in_mapper2),

    .recv_ports_3_putCredits_cr_in(mapper2_put_credit),
    .EN_recv_ports_3_putCredits(en_mapper2_put_credit),

    .EN_recv_ports_4_getFlit(1'b1), // mapper 3
    .recv_ports_4_getFlit(flit_in_mapper3),

    .recv_ports_4_putCredits_cr_in(mapper3_put_credit),
    .EN_recv_ports_4_putCredits(en_mapper3_put_credit),
...
noc_input_controller i_noc_input_controller (
    ...
    .en_get_credit_mapper2(arb_rdy_get_credit_mapper0),
    .get_credit_mapper2(arb_get_credit_mapper0),
    .en_get_credit_mapper3(arb_rdy_get_credit_mapper0),
    .get_credit_mapper3(arb_get_credit_mapper0),
    .flit_out(flit)
);
...
MapReduceMapper_unq1 i_MapReduceMapper_unq1_2 (
    ...
    .task_id(), // not used
    .key("                                the     "), // word to be counted, # chars must be equal to hex digits of word in mapper module
    .value(flit_in_mapper2[`DATA_WIDTH-1:0]),
    .clk(CLK), // clk
    .rstn(RST_N), // global active low reset
    .put_credits_mapper(mapper2_put_credit),
    .en_put_credits_mapper(en_mapper2_put_credit),
    .get_credit(mapper2_get_credit),
    .en_get_credit(mapper2_rdy_get_credit),
    .clear(), //
    .tail(flit_in_mapper2[flit_port_width-2]),
    .finish(), // end of mapping step
    .read_request(), // not used
    .write_request(), // not used
    .int_key(key_out_mapper2), // not used
    .int_value(value_out_mapper2), // result, goes to reducer
    .read_addr(), // not used
    .write_addr(), // not used, tied to task_id
    .flit_out_mapper(flit_out_mapper2) // flit: mapper out, reducer in
);
...
MapReduceMapper_unq1 i_MapReduceMapper_unq1_3 (
    ...
    .task_id(), // not used
    .key("                                the     "), // word to be counted, # chars must be equal to hex digits of word in mapper module
    .value(flit_in_mapper3[`DATA_WIDTH-1:0]),
    .clk(CLK), // clk
    .rstn(RST_N), // global active low reset
    .put_credits_mapper(mapper3_put_credit),
    .en_put_credits_mapper(en_mapper3_put_credit),
    .get_credit(mapper3_get_credit),
    .en_get_credit(mapper3_rdy_get_credit),
    .clear(), //
    .tail(flit_in_mapper3[flit_port_width-2]),
    .finish(), // end of mapping step
    .read_request(), // not used
    .write_request(), // not used
    .int_key(key_out_mapper3), // not used
    .int_value(value_out_mapper3), // result, goes to reducer
    .read_addr(), // not used
    .write_addr(), // not used, tied to task_id
    .flit_out_mapper(flit_out_mapper3) // flit: mapper out, reducer in
);
