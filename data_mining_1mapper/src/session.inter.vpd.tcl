...
# DVE full session
# Saved on Sat Nov 26 02:05:09 2016
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/afs/asu.edu/users/c/f/a/cfarnsw2/datamining/data_mining/src/session.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{593 86} {1616 901}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 343} {child_wave_right 675} {child_wave_colname 203} {child_wave_colvalue 138} {child_wave_col1 0} {child_wave_col2 1}}
...
set _session_group_66 input_arb
gui_sg_create "$_session_group_66"
set input_arb "$_session_group_66"

gui_sg_addsignal -group "$_session_group_66" { CONNECT_testbench_sample.i_top_level.i_noc_input_controller.en_get_credit CONNECT_testbench_sample.i_top_level.i_noc_input_controller.get_credit CONNECT_testbench_sample.i_top_level.i_noc_input_controller.num_credits }

set _session_group_67 Group1
gui_sg_create "$_session_group_67"
set Group1 "$_session_group_67"

gui_sg_addsignal -group "$_session_group_67" { CONNECT_testbench_sample.i_top_level.i_MapReduceMapper_unq1_1.value }
gui_set_radix -radix {ascii} -signals {Sim:CONNECT_testbench_sample.i_top_level.i_MapReduceMapper_unq1_1.value}
gui_set_radix -radix {unsigned} -signals {Sim:CONNECT_testbench_sample.i_top_level.i_MapReduceMapper_unq1_1.value}
...
gui_open_source -id ${Source.1}  -replace -active CONNECT_testbench_sample.i_top_level.i_MapReduceMapper_unq1_1 MapReduceMapper_unq1.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 656375000
...
gui_list_select -id ${Wave.1} {CONNECT_testbench_sample.i_top_level.i_MapReduceReducer_unq1.result }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group reducer  -item {CONNECT_testbench_sample.i_top_level.i_MapReduceReducer_unq1.put_credits_reducer[1:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 443929962
gui_view_scroll -id ${Wave.1} -vertical -set 617
